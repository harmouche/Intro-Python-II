...
room['treasure'].item_list.append(Item("sword", "The Excalibur is yours!"))
room['treasure'].item_list.append(Item("crown", "The new king shall rise!"))
room['overlook'].item_list.append(Item("map", "Where do you want to go?"))
room['foyer'].item_list.append(Item("torch", "to light your dark path"))
